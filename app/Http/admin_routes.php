...
Route::group(['as' => $as, 'middleware' => ['auth', 'permission:ADMIN_PANEL']], function () {
	...
	/* ================== Boards ================== */
	Route::resource(config('laraadmin.adminRoute') . '/boards', 'LA\BoardsController');
	Route::get(config('laraadmin.adminRoute') . '/board_dt_ajax', 'LA\BoardsController@dtajax');

	/* ================== Class_Masters ================== */
	Route::resource(config('laraadmin.adminRoute') . '/class_masters', 'LA\Class_MastersController');
	Route::get(config('laraadmin.adminRoute') . '/class_master_dt_ajax', 'LA\Class_MastersController@dtajax');
