...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2020 at 07:55 AM
...
CREATE TABLE `boards` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `board_name` varchar(256) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `board_description` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `boards` (`id`, `deleted_at`, `created_at`, `updated_at`, `board_name`, `board_description`, `status`) VALUES
...
CREATE TABLE `class_masters` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `class_name` varchar(256) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `class_description` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `status` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Active'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `class_masters` (`id`, `deleted_at`, `created_at`, `updated_at`, `class_name`, `class_description`, `status`) VALUES
...
(8, 'Permissions', 'permissions', 'fa-magic', 'module', 1, 5, '2020-11-11 23:58:02', '2020-11-12 01:05:16'),
...
(52, 'subject_name', 'Subject Name', 9, 22, 0, '', 0, 256, 1, '', 0, '2020-11-12 00:55:09', '2020-11-12 00:55:09'),
(53, 'subject_description', 'Subject Description', 9, 22, 0, '', 0, 256, 0, '', 0, '2020-11-12 00:55:54', '2020-11-12 00:55:54'),
(54, 'board_name', 'Board Name', 10, 22, 0, '', 0, 256, 1, '', 0, '2020-11-12 00:57:34', '2020-11-12 00:57:34'),
(55, 'board_description', 'Board Description', 10, 22, 0, '', 0, 256, 0, '', 0, '2020-11-12 00:57:58', '2020-11-12 00:57:58'),
(59, 'status', 'Status', 10, 7, 0, 'Active', 0, 0, 0, '[\"Active\",\"Inactive\"]', 0, '2020-11-12 01:04:14', '2020-11-12 01:04:14'),
(60, 'class_name', 'Class Name', 11, 22, 0, '', 0, 256, 1, '', 0, '2020-11-12 01:11:40', '2020-11-12 01:11:40'),
(61, 'class_description', 'Class Description', 11, 22, 0, '', 0, 256, 0, '', 0, '2020-11-12 01:11:55', '2020-11-12 01:11:55'),
...
CREATE TABLE `subjects` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `subject_name` varchar(256) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `subject_description` varchar(256) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `subjects` (`id`, `deleted_at`, `created_at`, `updated_at`, `subject_name`, `subject_description`) VALUES
